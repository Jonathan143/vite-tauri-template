// vscode 插件配置 ( Visual Studio Code Commitizen Support )[https://link.juejin.cn/?target=https%3A%2F%2Fmarketplace.visualstudio.com%2Fitems%3FitemName%3DKnisterPeter.vscode-commitizen]
...
module.exports = {
  ...
  types: [
    ...
    { value: 'ci', name: '🔧 对 CI 配置文件和脚本的更改' },
    {
      value: 'chore',
      name: '🤖 一些与主要业务无关的构建/工程依赖/工具等功能改动',
    },
